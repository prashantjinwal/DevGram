...
export const ProjectBar = () => {
    return (
        <div className="w-full mt-5 border-b-2 border-gray-500   flex justify-between p-4">
            <button className="hidden md:block text-blue-700 font-semibold md:text-2xl  text-2xl ">&lt; <FoundationIcon fontSize='large' sx={{ color: 'white' }} /> /&gt;</button>
            <button className="md:hidden text-blue-700 font-semibold md:text-2xl  text-2xl ">&lt; <FoundationIcon fontSize='medium' sx={{ color: 'white' }} /> /&gt;</button>
